...
//create the main class for find property status
public class FindStatus extends JFrame 
{
    ...
    //constructor
    public FindStatus(String findStatus)
    {
        ...
        try{
            ...
            String query = "select * from property where propertyStatus ='"+findStatus+"'"; //select properties from database 
