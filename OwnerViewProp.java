...
//create the main class for view property
public class OwnerViewProp extends JPanel{
    ...
    public OwnerViewProp(){
        ...
        defaultTableModel.addColumn("Facilities");
