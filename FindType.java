...
//create the main class for find property type
public class FindType extends JFrame 
{
    ...
    //constructor
    public FindType(String findType)
    {
        ...
        try{
            ...
            String query = "select * from property where propertyType ='"+findType+"'"; //select properties from database 
