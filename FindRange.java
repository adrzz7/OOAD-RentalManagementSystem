...
//create the main class for find property price range
public class FindRange extends JFrame 
{
    ...
    //constructor
    public FindRange(int pricemax, int pricemin)
    {
        ...
        try{
            ...
            String query = "select propertyID, propertyType, propertyLocation, propertySize, propertyRentRate, propertyStatus, propertyNoOfRooms, propertyNoOfBathrooms, propertyFacilities from property WHERE propertyRentRate >="+pricemin+" AND propertyRentRate<="+pricemax;
