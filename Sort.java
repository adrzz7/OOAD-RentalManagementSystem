...
//create the main class for sort property
public class Sort extends JFrame 
{
    ...
    public Sort(String fsort)
    {
        ...
        try{
            ...
            String query = "select propertyID, propertyType, propertyLocation, propertySize, propertyRentRate, propertyStatus, propertyNoOfRooms, propertyNoOfBathrooms, propertyFacilities from property ORDER BY propertyRentRate DESC";
        ...
        frame2.add(new JScrollPane(table));
            ...
            String query = "select propertyID, propertyType, propertyLocation, propertySize, propertyRentRate, propertyStatus, propertyNoOfRooms, propertyNoOfBathrooms, propertyFacilities from property ORDER BY propertyRentRate ASC";
            ResultSet rs = st.executeQuery(query);
